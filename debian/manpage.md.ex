% libnss-altfiles(SECTION) | User Commands
%
% "September 26 2025"
...
libnss-altfiles - program to do something

# SYNOPSIS

**libnss-altfiles** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libnss-altfiles** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libnss-altfiles** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libnss-altfiles** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libnss-altfiles. See **foo.conf**(5) for further details.
...
**libnss-altfiles** provides some return codes, that can be used in scripts:
